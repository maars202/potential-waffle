...
// * contracts/Rental.sol (^0.8.4) imports @chainlink/contracts/src/v0.6/interfaces/AggregatorV3Interface.sol (^0.6.0)
// incompatible versions of solidity:
...
// https://towardsdatascience.com/creating-an-ethereum-token-to-enable-a-decentralized-rent-to-own-network-cc3786cf1142