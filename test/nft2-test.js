...
describe("NFT test", function () {
    ...
    // Should throw an error due to insufficient deposit 
    ...
    it("-", async function () {
        ...
        try{
            ...
            Error occurred: To purchase this NFT, you will have to have 30% of the NFT listing price and 
            at least 6 months worth of monthly instalments.


            Thank you for paying the deposit. The monthly instalments over the span of 30 years will now be 
    ...
    it("6. Scheduling payments ", async function () {
        ...
        all_market_nfts = await nft2.fetchListingItems()
        console.log("all_market_nfts: ", all_market_nfts)
        ...
        console.log(`- One month later - Thank you for paying the monthly instalments for your NFT property.`)
